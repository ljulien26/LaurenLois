...
- Cinéma façade (place4) : **3 séances**, une par porte — gauche **Heureux gagnants**, centre **F1**, droite **Materialists** (les 4 affiches d'un groupe sont déjà dans le décor `4.png`). Les **3 portes ont un halo** (vif sur celle à portée de Lauren, `PLACE4_DOOR_REACH=120`, centres `209 / 483 / 759`, sol `385`) ; **cliquer un bandeau d'affiches** (`PLACE4_DOORS[i].posters`) l'ouvre **en grand** (clic pour refermer). Entrer par une porte enregistre le choix dans **`place4Choice`** (0/1/2) → place5. ⏳ **À venir** : la question « quand avons-nous vu ce film ? » (dates par film, pas encore fournies) et ce qui change dans la salle selon `place4Choice`.
